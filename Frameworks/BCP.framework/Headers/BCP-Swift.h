...
SWIFT_CLASS("_TtC3BCP9BCPClient")
@interface BCPClient : NSObject
/// Singleton member of the class.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) BCPClient * _Nonnull sharedInstance;)
+ (BCPClient * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
/// Call server and obtain token.
/// \param clientId Client id
///
/// \param secret Secret code
///
- (void)setCloudConfigWithClientId:(NSString * _Nonnull)clientId secret:(NSString * _Nonnull)secret;
/// Beginning of the monitoring.
- (void)startMonitoringService;
/// Finishing of the monitoring.
- (void)stopMonitoringService;
/// Activation of the debugging.
/// \param bool Enable or Disable
///
- (void)enableLog:(BOOL)bool_;
@end


@interface BCPClient (SWIFT_EXTENSION(BCP))
@end
...
@interface BCPClient (SWIFT_EXTENSION(BCP)) <CLLocationManagerDelegate>
...
@interface CLBeacon (SWIFT_EXTENSION(BCP))
@property (nonatomic, readonly) NSInteger hashValue;
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end


@interface CLBeaconRegion (SWIFT_EXTENSION(BCP))
@end


@interface NSData (SWIFT_EXTENSION(BCP))
@end


@interface NSNumber (SWIFT_EXTENSION(BCP))
@end
...
SWIFT_CLASS("_TtC3BCP15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(BCP)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(BCP)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(BCP)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(BCP)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(BCP)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC3BCP12TaskDelegate")
...
@interface NSURLSession (SWIFT_EXTENSION(BCP))
@end
